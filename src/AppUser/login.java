...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Hai Moviegoers!");

        jLabel3.setForeground(new java.awt.Color(102, 102, 102));
        jLabel3.setText("Sudah siap merasakan pengalaman menonton");

        jLabel4.setForeground(new java.awt.Color(102, 102, 102));
        jLabel4.setText("yang tidak terlupakan?");

        jLabel5.setText("Belum punya akun? ");

        t_register.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        t_register.setForeground(new java.awt.Color(0, 51, 102));
        t_register.setText("Daftar di sini");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(t_password, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(bt_login, javax.swing.GroupLayout.PREFERRED_SIZE, 274, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(jLabel5)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(t_register)))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(t_register, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(57, 57, 57)
    ...
    private void bt_loginMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bt_loginMouseClicked
          try {
            sql = "SELECT * FROM users WHERE username='"+t_username.getText()+"' AND password='"+t_password.getText()+"'";
            rs = stm.executeQuery(sql);
            if(rs.next()){
                if(t_username.getText().equals(rs.getString("username")) && t_password.getText().equals(rs.getString("password"))){
